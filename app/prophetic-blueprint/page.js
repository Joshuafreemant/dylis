  ...
  return (
    <main className="flex flex-col color-custom md:flex-row-reverse md:h-screen items-center">
      ...
      <div className="md:w-5/12 md:flex-1 md:p-12 md:h-full mt-0   w-full p-3 flex justify-center items-center flex-col">
        <h4 className="text-white my-6 font-semibold">
          #THEPROPPHETICBLUEPRINT
        </h4>
        ...
        <p className="my-4 font-normal text-white text-center">
          ...
          exhausted being a passive bystander to your own potential? Tired of
          playing small? Are you ready to step into the greatness that’s within
          your reach? Do you feel an intense desire to make an undeniable impact
          and touch lives? Dylis takes you on an inspiring journey, guiding you
          through a transformative process that leads to profound impact and
          purposeful living.
        </p>
        <div className="flex gap-3 mt-2 mb-16">
          <Link
            href="https://www.amazon.co.uk/Prophetic-Blueprint-Unlock-Activate-Unstoppable/dp/1982287551/ref=sr_1_1?crid=3MSM2K1AZ0D75&keywords=the+prophetic+blueprint&qid=1695631523&sprefix=the+prophetic+blueprint%2Caps%2C58&sr=8-1"
